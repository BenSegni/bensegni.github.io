...
export class InfoDirective implements AfterViewInit {
    ...
    constructor(
        ...
        private _creator: DOMCreatorService
    ) { }

    public ngAfterViewInit(): void {
        if (this.tooltip) this._creator.createIconElement(this.tooltip, this._el);
    }
    ...
    private generateInfoBox(text: string): HTMLElement {
        ...
        if (this.tooltip?.link && this.tooltip.linkText) {
            const linkText: string = this._creator.createInnerText(this.tooltip.linkText);

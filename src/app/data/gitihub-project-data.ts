...
export const githubProjectData: Github[] = [
    {
        ...
        skills: ['Angular', 'Cypress', 'Github', 'HTML5', 'Jasmine', 'RxJs', 'Typescript'],
        toolTip: {
    ...
    },
    {
        ...
        skills: ['Angular', 'Github', 'HTML5', 'Jasmine', 'Typescript'],
        toolTip: {
    ...
    },
    {
        ...
        skills: ['Angular', 'Github', 'HTML5', 'Jasmine', 'RxJs', 'Typescript'],
        toolTip: {
